...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_user', (
            ...
            ('reseller', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='agents', null=True, to=orm['users.User'])),
            ('user_type', self.gf('django.db.models.fields.CharField')(default='AG', max_length=2)),
        ))
