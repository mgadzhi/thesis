...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskOrdersMap.started'
        db.add_column(u'vrp_taskordersmap', 'started',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 18, 0, 0)),
                      keep_default=False)

        # Adding field 'TaskOrdersMap.finished'
        db.add_column(u'vrp_taskordersmap', 'finished',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskOrdersMap.started'
        db.delete_column(u'vrp_taskordersmap', 'started')

        # Deleting field 'TaskOrdersMap.finished'
        db.delete_column(u'vrp_taskordersmap', 'finished')
