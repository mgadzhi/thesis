...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskOrdersMap.task_id'
        db.alter_column(u'vrp_taskordersmap', 'task_id', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'TaskOrdersMap.task_id'
        db.alter_column(u'vrp_taskordersmap', 'task_id', self.gf('django.db.models.fields.CharField')(max_length=32))
