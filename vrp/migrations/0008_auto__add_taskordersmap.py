...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskOrdersMap'
        db.create_table(u'vrp_taskordersmap', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task_id', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('orders', self.gf('jsonfield.fields.JSONField')(default={})),
        ))
        db.send_create_signal(u'vrp', ['TaskOrdersMap'])


    def backwards(self, orm):
        # Deleting model 'TaskOrdersMap'
        db.delete_table(u'vrp_taskordersmap')
    ...
    models = {
        ...
        u'vrp.order': {
            ...
            'station': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'orders'", 'to': u"orm['vrp.Station']"}),
        ...
        u'vrp.taskordersmap': {
            'Meta': {'object_name': 'TaskOrdersMap'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orders': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'task_id': ('django.db.models.fields.CharField', [], {'max_length': '32'})
        },
        u'vrp.vehicle': {
