...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Depot', fields ['y', 'x']
        db.create_unique(u'vrp_depot', ['y', 'x'])

        # Adding unique constraint on 'Station', fields ['y', 'x']
        db.create_unique(u'vrp_station', ['y', 'x'])


    def backwards(self, orm):
        # Removing unique constraint on 'Station', fields ['y', 'x']
        db.delete_unique(u'vrp_station', ['y', 'x'])

        # Removing unique constraint on 'Depot', fields ['y', 'x']
        db.delete_unique(u'vrp_depot', ['y', 'x'])
