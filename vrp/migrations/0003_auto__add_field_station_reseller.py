...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.reseller'
        db.add_column(u'vrp_station', 'reseller',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=8, to=orm['users.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Station.reseller'
        db.delete_column(u'vrp_station', 'reseller_id')
    ...
    models = {
        ...
        u'vrp.station': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reseller': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.User']"}),
            'x': ('django.db.models.fields.IntegerField', [], {}),
            'y': ('django.db.models.fields.IntegerField', [], {})
        },
        u'vrp.vehicle': {
