...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Station.reseller'
        db.alter_column(u'vrp_station', 'reseller_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Reseller']))

    def backwards(self, orm):

        # Changing field 'Station.reseller'
        db.alter_column(u'vrp_station', 'reseller_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))
