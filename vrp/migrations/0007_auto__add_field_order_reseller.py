...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.reseller'
        db.add_column(u'vrp_order', 'reseller',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=7, to=orm['users.Reseller']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.reseller'
        db.delete_column(u'vrp_order', 'reseller_id')
